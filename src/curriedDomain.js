...
function curried(protocol) {
  return function(prot){
    return function(domain){
      return function(upDomain){
        return protocol(prot,domain,upDomain)
      }
    }
  }
}
...
function concat(prot,domain,upDomain){
  return prot+":/\/"+domain+"."+upDomain
}

let curriedDomain = curried(concat)
